...
namespace Infernity.Framework.Plugins.Isolation
{
    ...
    /// </summary>
    public class AssemblyLoaderConfiguration
    {
        /// <summary>
        /// Initializes a new instance of <see cref="AssemblyLoaderConfiguration" />
        /// </summary>
        /// <param name="mainAssemblyPath">The full file path to the main assembly for the plugin.</param>
        public AssemblyLoaderConfiguration(string mainAssemblyPath)
        {
        ...
        /// <summary>
        /// If set, replaces the default <see cref="AssemblyLoadContext"/> used by the <see cref="AssemblyLoader"/>.
