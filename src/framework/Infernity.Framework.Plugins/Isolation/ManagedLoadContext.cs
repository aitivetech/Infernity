...
namespace Infernity.Framework.Plugins.Isolation
{
    ...
    internal class ManagedLoadContext : AssemblyLoadContext
    {
            ...
            : base(Path.GetFileNameWithoutExtension(mainAssemblyPath), isCollectible)
        {
            ...
            var actualMainAssemblyPath = mainAssemblyPath ?? throw new ArgumentNullException(nameof(mainAssemblyPath));
            _dependencyResolver = new AssemblyDependencyResolver(actualMainAssemblyPath);
            _basePath = Path.GetDirectoryName(mainAssemblyPath) ?? throw new ArgumentException(nameof(actualMainAssemblyPath));
            ...
            _mainAssemblyPath = actualMainAssemblyPath;
