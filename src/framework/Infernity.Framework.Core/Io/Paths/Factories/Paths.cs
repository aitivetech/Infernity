namespace Infernity.Framework.Core.Io.Paths.Factories
{
    ...
    public static class Paths
    {
        ...
        /// </summary>
        public static IPath? CurrentDirectory => Factory.Create(Environment.CurrentDirectory, FactoryOptions);

        /// <summary>
        /// Gets the fully-qualified path of the system directory as an IPath.
        /// </summary>
        public static IPath? SystemDirectory => Factory.Create(Environment.SystemDirectory, FactoryOptions);
    }
}
