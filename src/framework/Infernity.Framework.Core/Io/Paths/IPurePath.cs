...
namespace Infernity.Framework.Core.Io.Paths
{
    ...
    public interface IPurePath
    {
        ...
        /// <returns></returns>
        bool TrySafeJoin(string relativePath, [NotNullWhen(true)]out IPurePath? joined);
        ...
        /// <param name="joined"></param>
        /// <returns></returns>
        bool TrySafeJoin(IPurePath relativePath, [NotNullWhen(true)]out IPurePath? joined);
        ...
        where TPath : IPurePath
    {
        ...
        /// <param name="joined"></param>
        /// <returns></returns>
        bool TrySafeJoin(string path, [NotNullWhen(true)]out TPath? joined);
        ...
        /// <param name="joined"></param>
        /// <returns></returns>
        bool TrySafeJoin(IPurePath path, [NotNullWhen(true)]out TPath? joined);
