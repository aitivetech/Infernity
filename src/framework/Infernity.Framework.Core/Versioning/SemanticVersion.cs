...
public class SemanticVersion : IEquatable<SemanticVersion>, IComparable<SemanticVersion>,IParsable<SemanticVersion>
{
    private const string WildcardSymbol = "*";

    private static IComparer<SemanticVersion> s_comparer = new SemanticVersionComparer();
    ...
    public static SemanticVersion Parse(string versionString,IFormatProvider? formatProvider = null)
    {
        if (!TryParse(versionString, formatProvider,out var version))
        {
    ...
    public static bool TryParse(string? versionString,IFormatProvider? formatProvider, [NotNullWhen(true)]out SemanticVersion? version)
    {
        version = null;
